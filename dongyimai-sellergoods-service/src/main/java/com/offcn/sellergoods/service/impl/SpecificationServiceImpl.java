...
public class SpecificationServiceImpl implements SpecificationService {
	...
	public Specification findOne(Long id){
		...
		Specification specification=new Specification(Specification,specificationOptions);
	...
	@Override
	public List<Map> findSpecificOption() {
		List<Map> specificOption = specificationMapper.findSpecificOption();
